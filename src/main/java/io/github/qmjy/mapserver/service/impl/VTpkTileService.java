...
@Service
public class VTpkTileService extends BaseTileService {

    private static final Logger LOGGER = LoggerFactory.getLogger(VTpkTileService.class);

    private final String FOLDER_OF_TILESET = "tilesets";
    private final String FILE_EXTENSION_OF_TPK = ".vtpk";

    private final AppConfig appConfig;

    public VTpkTileService(AppConfig appConfig) {
